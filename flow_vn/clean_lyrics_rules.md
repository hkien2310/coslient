Tóm tắt tác dụng của file: Tài liệu này quy định các quy tắc để chuẩn hóa định dạng lời bài hát sạch (clean lyrics) cho dự án Coslient, phục vụ cho việc tải lên các nền tảng phát hành nhạc như DistroKid hay Bandcamp.

# Quy tắc Lời bài hát Sạch (Clean Lyrics) — Dự án Coslient

> **Dùng khi:** Tải lời bài hát (lyrics) lên DistroKid, Bandcamp, hoặc bất kỳ nền tảng nào yêu cầu lời bài hát sạch (clean lyrics).
> **Áp dụng cho:** Mọi bài nhạc từ video 41 trở đi.

---

## Các quy tắc (9 quy tắc)

| # | Quy tắc | Ví dụ sai | Ví dụ đúng |
|---|------|-----------|-----------|
| 1 | **Chỉ viết lời bài hát. Không có thông tin khác.** | `Song title, artist name, genre…` | _(bỏ hết)_ |
| 2 | **Không ghi tên ca sĩ (vocalist).** | `[Coslient]: When love walks tall` | `When love walks tall` |
| 3 | **Không có văn bản thừa (intro, chorus, liên kết mạng xã hội…).** | `[Verse 1]`, `[Chorus 2x]`, `fb.com/coslient` | _(xóa hết)_ |
...
| 7 | **Dòng trắng chỉ dùng để phân cách phiên khúc (verse) / điệp khúc (chorus). Không để nhiều hơn 1 dòng trắng.** | `[blank][blank]` giữa 2 câu | 1 dòng trắng duy nhất |
...
| 9 | **Không kiểm duyệt từ nhạy cảm trừ khi bị che tiếng (bleep) trong bản thu.** | `F***` | `F***` chỉ khi bị che tiếng (bleep); nếu không bị che tiếng thì viết thẳng |

---

## Các lỗi phổ biến cần tránh

### ❌ Các thẻ đánh dấu đoạn (Section markers)
```
[Verse 1]
[Pre-Chorus]
[Bridge]
...
### ❌ Kéo dài âm tiết
```
The waaater hooollds your weeeight   ← ký hiệu Suno
```
...
### ❌ Chỉ dẫn biểu diễn (Stage directions)
```
[spoken, soft]
[sigh]
[fade out]
...
### ❌ Giọng bè hát đệm trong ngoặc đơn (Parenthetical backing vocals)
```
It takes the heavy things away (for your name)
```
→ Quyết định: nếu đó là giọng bè (backing vocal) chính thì giữ và viết thành dòng riêng. Nếu là ghi chú thì xóa.
...
## Áp dụng cho dự án Coslient

Tất cả các tệp `03_clean_lyrics.txt` từ video 41–53 đã được chuẩn hóa theo các quy tắc này.

| Video | Tên bài hát | Tệp |
|-------|-----------|------|
